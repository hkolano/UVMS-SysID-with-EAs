...
# Tried to run julia code in one giant eval and that errored out
# I think it tried to run it all as one line

# Main.include(str(Path.cwd() / "src" / "julia-sim" / "HydroCalc.jl"))
# Main.include(str(Path.cwd() / "src" / "julia-sim" / "SimWExt.jl"))
# Main.include(str(Path.cwd() / "src" / "julia-sim" / "PIDCtlr.jl"))
# Main.include(str(Path.cwd() / "src" / "julia-sim" / "UVMSPlotting.jl"))
# Main.include(str(Path.cwd() / "src" / "julia-sim" / "HelperFuncs.jl"))
# Main.include(str(Path.cwd() / "src" / "julia-sim" / "Noiser.jl"))

# Main.include(str(Path.cwd() / "src" / "julia-sim" / "UVMSsetup.jl"))
# Main.include(str(Path.cwd() / "src" / "julia-sim" / "ConfigFiles/MagicNumPitchVal.jl"))
# Main.include(str(Path.cwd() / "src" / "julia-sim" / "ConfigFiles/ConstMagicNums.jl"))
# Main.include(str(Path.cwd() / "src" / "julia-sim" / "ConfigFiles/MagicNumBlueROVHardware.jl"))
# Main.include(str(Path.cwd() / "src" / "julia-sim" / "ConfigFiles/MagicNumAlpha.jl"))
