...
using StaticArrays, RigidBodyDynamics

mutable struct MagicNumBlueRov
    ...
    vehicle_extras_list::Vector{String}
    d_lin_coeffs::Vector{Float64}
    d_nonlin_coeffs::Vector{Float64}
end

function create_magic_num_bluerov()
    ...
    MagicNumBlueRov(
        cob_vec_dict, buoyancy_mag_dict, buoyancy_force_dict, com_vec_dict, grav_mag_dict,
        gravity_force_dict, vehicle_extras_list, d_lin_coeffs, d_nonlin_coeffs
    )
end
#=
