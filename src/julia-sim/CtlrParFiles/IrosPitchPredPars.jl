struct PitchPredPars
    # Struct for controller parameters used for the pitch prediction trials for the IROS redo
    Kp_dict::Dict{String, Float64}
    Ki_dict::Dict{String, Float64}
    Kd_dict::Dict{String, Float64}
...
function create_iros_pitch_pred_pars()::PitchPredPars
...
# Note: This function does not seem to be called anywhere
